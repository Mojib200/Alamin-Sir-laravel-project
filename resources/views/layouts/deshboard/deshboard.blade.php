...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/deshboard') }}/images/favicon.png">
    <link rel="stylesheet" href="{{ asset('/deshboard') }}/vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('/deshboard') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="{{ asset('/deshboard') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="{{ asset('/deshboard') }}/css/style.css" rel="stylesheet">
    <link
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('/deshboard') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('/deshboard') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('/deshboard') }}/images/logo-text.png" alt="">
            </a>
            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('categorie.create') }}">Add Categorie </a></li>

                            <li><a href="{{ route('categorie.index') }}">View Categorie</a></li>
                        </ul>
                    </li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('variation.create') }}">Add Variation </a></li>
                        <li><a href="{{ route('color.index') }}">Color</a></li>
                        {{-- <li><a href="{{ route('variation.index') }}">View Variation</a></li> --}}
                    </ul>
                </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ asset('/deshboard') }}/page-register.html">Register</a></li>
                            <li><a href="{{ asset('/deshboard') }}/page-login.html">Login</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                                <ul aria-expanded="false">
                                    <li><a href="{{ asset('/deshboard') }}/page-error-400.html">Error 400</a></li>
                                    <li><a href="{{ asset('/deshboard') }}/page-error-403.html">Error 403</a></li>
                                    <li><a href="{{ asset('/deshboard') }}/page-error-404.html">Error 404</a></li>
                                    <li><a href="{{ asset('/deshboard') }}/page-error-500.html">Error 500</a></li>
                                    <li><a href="{{ asset('/deshboard') }}/page-error-503.html">Error 503</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ asset('/deshboard') }}/page-lock-screen.html">Lock Screen</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <!--**********************************
        ...
        ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('/deshboard') }}/vendor/global/global.min.js"></script>
    <script src="{{ asset('/deshboard') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    <script src="{{ asset('/deshboard') }}/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('/deshboard') }}/js/custom.min.js"></script>
    <script src="{{ asset('/deshboard') }}/js/deznav-init.js"></script>
    <script src="{{ asset('/deshboard') }}/vendor/owl-carousel/owl.carousel.js"></script>

    <!-- Chart piety plugin files -->
    <script src="{{ asset('/deshboard') }}/vendor/peity/jquery.peity.min.js"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('/deshboard') }}/vendor/apexchart/apexchart.js"></script>
